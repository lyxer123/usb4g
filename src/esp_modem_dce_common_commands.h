 ...
 *
 */
#define CONFIG_MODEM_COMMAND_TIMEOUT_DEFAULT 100
#define CONFIG_MODEM_COMMAND_TIMEOUT_OPERATOR "CMNET"
#define CONFIG_MODEM_COMMAND_TIMEOUT_RESET 100
#define CONFIG_MODEM_COMMAND_TIMEOUT_MODE_CHANGE 100
#define CONFIG_MODEM_COMMAND_TIMEOUT_POWEROFF 100
